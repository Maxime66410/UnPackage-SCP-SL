			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %138 
					     ...
					     UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %140 = OpAccessChain %14 %139 
					                                     f32 %141 = OpLoad %140 
					                            Uniform f32* %142 = OpAccessChain %14 %139 
					                                     f32 %143 = OpLoad %142 
					                            Uniform f32* %144 = OpAccessChain %14 %139 
					                                     f32 %145 = OpLoad %144 
					                                   f32_3 %146 = OpCompositeConstruct %141 %143 %145 
					                                     f32 %147 = OpCompositeExtract %146 0 
					                                     f32 %148 = OpCompositeExtract %146 1 
					                                     f32 %149 = OpCompositeExtract %146 2 
					                                   f32_3 %150 = OpCompositeConstruct %147 %148 %149 
					                                   f32_3 %151 = OpLoad %26 
					                                   f32_3 %152 = OpFMul %150 %151 
					                                   f32_3 %153 = OpLoad %104 
					                                   f32_3 %154 = OpFAdd %152 %153 
					                                   f32_4 %155 = OpLoad %138 
					                                   f32_4 %156 = OpVectorShuffle %155 %154 4 5 6 3 
					                                                  OpStore %138 %156 
					                             Output f32* %159 = OpAccessChain %138 %157 
					                                                  OpStore %159 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
