			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_9 = max(u_xlat10_1.z, u_xlat10_1.x);
					    u_xlat16_10 = u_xlat16_9 * 0.800000012;
					    u_xlat16_9 = (-u_xlat16_9) + u_xlat10_1.y;
					    u_xlat9 = u_xlat16_9 + (-_Value3);
					    u_xlat9 = u_xlat9 * 3.0;
					    u_xlat9 = clamp(u_xlat9, 0.0, 1.0);
					    u_xlat2.x = u_xlat10_1.y + (-_Value2);
					    u_xlat2.y = min(u_xlat16_10, u_xlat2.x);
					    u_xlat4 = u_xlat10_1.y + (-u_xlat2.y);
					    u_xlat2.xz = u_xlat10_1.xz;
					    u_xlat1.x = u_xlat4 + (-_Value4);
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                               ...
					                                               %1 = OpExtInstImport "GLSL.std.450" 
					                                                      OpMemoryModel Logical GLSL450 
					                                                      OpEntryPoint Fragment %4 "main" %28 %176 
					         ...
					         UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					                   ...
					                   read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                                        ...
					                                        f32_3 %85 = OpVectorShuffle %84 %84 0 1 2 
					                                                      OpStore %76 %85 
					                                 Private f32* %87 = OpAccessChain %61 %18 
					                                          f32 %88 = OpLoad %87 
					                                 Uniform f32* %90 = OpAccessChain %14 %89 
					                                          ...
					                                          f32 %93 = OpFAdd %88 %92 
					                                                      OpStore %86 %93 
					                                 Private f32* %95 = OpAccessChain %61 %59 
					                                          f32 %96 = OpLoad %95 
					                                ...
					                                Private f32* %126 = OpAccessChain %122 %18 
					                                                      OpStore %126 %125 
					                                Private f32* %127 = OpAccessChain %61 %18 
					                                         f32 %128 = OpLoad %127 
					                                Private f32* %129 = OpAccessChain %122 %18 
					                                         f32 %130 = OpLoad %129 
					                                       ...
					                                       f32_3 %136 = OpVectorShuffle %135 %134 3 1 4 
					                                                      OpStore %122 %136 
					                                         f32 %138 = OpLoad %43 
					                                Uniform f32* %140 = OpAccessChain %14 %139 
					                                         f32 %141 = OpLoad %140 
					                                         f32 %142 = OpFNegate %141 
					                                         f32 %143 = OpFAdd %138 %142 
					                                Private f32* %144 = OpAccessChain %137 %97 
					                                                      OpStore %144 %143 
					                                       f32_3 %145 = OpLoad %137 
					                                       f32_3 %146 = OpVectorShuffle %145 %145 0 0 0 
					                                       f32_3 %147 = OpLoad %122 
					                                       f32_3 %148 = OpFAdd %146 %147 
					                                                      OpStore %137 %148 
					                                       f32_3 %149 = OpLoad %137 
					                                Uniform f32* %151 = OpAccessChain %14 %150 
					                                         f32 %152 = OpLoad %151 
					                                Uniform f32* %154 = OpAccessChain %14 %153 
					                                         f32 %155 = OpLoad %154 
					                                Uniform f32* %157 = OpAccessChain %14 %156 
					                                         f32 %158 = OpLoad %157 
					                                       f32_3 %159 = OpCompositeConstruct %152 %155 %158 
					                                       f32_3 %160 = OpFAdd %149 %159 
					                                                      OpStore %137 %160 
					                                       f32_3 %161 = OpLoad %137 
					                                       ...
					                                       f32_3 %170 = OpFAdd %168 %169 
					                                                      OpStore %137 %170 
					                                       f32_3 %171 = OpLoad %76 
					                                       f32_3 %172 = OpFNegate %171 
					                                       f32_3 %173 = OpLoad %137 
					                                       f32_3 %174 = OpFAdd %172 %173 
					                                                      OpStore %137 %174 
					                                Uniform f32* %178 = OpAccessChain %14 %177 
					                                         f32 %179 = OpLoad %178 
					                                Uniform f32* %180 = OpAccessChain %14 %177 
					                                         f32 %181 = OpLoad %180 
					                                Uniform f32* %182 = OpAccessChain %14 %177 
					                                         f32 %183 = OpLoad %182 
					                                       ...
					                                       f32_4 %194 = OpVectorShuffle %193 %192 4 5 6 3 
					                                                      OpStore %176 %194 
					                                 Output f32* %197 = OpAccessChain %176 %195 
					                                                      OpStore %197 %47 
					                                                      OpReturn
					                                                      OpFunctionEnd"
				}
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = u_xlat10_0.y + (-_Value2);
					    u_xlat16_10 = max(u_xlat10_0.z, u_xlat10_0.x);
					    ...
					    u_xlat2.y = min(u_xlat9, u_xlat16_2);
					    u_xlat3 = u_xlat10_0.y + (-u_xlat2.y);
					    u_xlat2.xz = u_xlat10_0.xz;
