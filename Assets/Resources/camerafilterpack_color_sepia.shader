			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_1.xyz = vec3(u_xlat16_6) + vec3(0.437000006, 0.171000004, 0.0780000016);
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %65 
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Uniform f32* %68 = OpAccessChain %16 %66 
					                                 f32 %69 = OpLoad %68 
					                        Uniform f32* %70 = OpAccessChain %16 %66 
					                                 f32 %71 = OpLoad %70 
					                        Uniform f32* %72 = OpAccessChain %16 %66 
					                                 f32 %73 = OpLoad %72 
					                               ...
					                               f32_4 %84 = OpVectorShuffle %83 %82 4 5 6 3 
					                                             OpStore %65 %84 
					                         Output f32* %89 = OpAccessChain %65 %87 
					                                             OpStore %89 %85 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
