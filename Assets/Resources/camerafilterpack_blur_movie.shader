			...
			Program "vp" {
					...
					void main()
					{
					    ...
					    while(true){
					        ...
					        while(true){
					            ...
					            u_xlat7 = u_xlat16_7 * u_xlat16.xxxx + vec4(1.0, 1.0, 1.0, 1.0);
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %11 %174 
					    ...
					    UniformConstant read_only Texture2D* %135 = OpVariable UniformConstant 
					                ...
					                UniformConstant sampler* %139 = OpVariable UniformConstant 
					                          ...
					                          Private f32_4* %152 = OpVariable Private 
					                                   f32_4 %157 = OpConstantComposite %58 %58 %58 %58 
					                                         %173 = OpTypePointer Output %13 
					                           ...
					                           Uniform f32_4* %60 = OpAccessChain %16 %37 
					                            ...
					                            Private f32* %122 = OpAccessChain %113 %51 
					                                                  OpStore %122 %121 
					                                   f32_2 %123 = OpLoad %57 
					                                   f32_2 %124 = OpLoad %113 
					                                   f32_2 %125 = OpFMul %123 %124 
					                                                  OpStore %113 %125 
					                                   f32_2 %126 = OpLoad %113 
					                                     f32 %127 = OpLoad %50 
					              ...
					              read_only Texture2DSampled %142 = OpSampledImage %136 %140 
					                                   f32_2 %143 = OpLoad %113 
					                                   f32_4 %144 = OpImageSampleExplicitLod %142 %143 Lod %13 
					                                                  OpStore %132 %144 
					                                   f32_4 %146 = OpLoad %132 
					                                   f32_4 %147 = OpLoad %132 
