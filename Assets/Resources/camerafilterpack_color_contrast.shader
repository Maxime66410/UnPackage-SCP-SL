			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = vec3(vec3(_Contrast, _Contrast, _Contrast)) * u_xlat16_0.xyz + vec3(0.5, 0.5, 0.5);
					    SV_Target0.w = 1.0;
					    return;
					}
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Uniform f32* %53 = OpAccessChain %16 %51 
					                                 f32 %54 = OpLoad %53 
					                        Uniform f32* %55 = OpAccessChain %16 %51 
					                                 f32 %56 = OpLoad %55 
					                        Uniform f32* %57 = OpAccessChain %16 %51 
					                                 f32 %58 = OpLoad %57 
