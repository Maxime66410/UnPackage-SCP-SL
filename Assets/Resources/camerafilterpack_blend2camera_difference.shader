			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %130 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                   ...
					                                   f32_3 %123 = OpFAdd %121 %122 
					                                                  OpStore %26 %123 
					                                   f32_3 %124 = OpLoad %104 
					                                   f32_3 %125 = OpFNegate %124 
					                                   f32_3 %126 = OpLoad %26 
					                                   f32_3 %127 = OpExtInst %1 4 %126 
					                                   f32_3 %128 = OpFAdd %125 %127 
					                                                  OpStore %26 %128 
					                            Uniform f32* %132 = OpAccessChain %14 %131 
					                                     f32 %133 = OpLoad %132 
					                            Uniform f32* %134 = OpAccessChain %14 %131 
					                                     f32 %135 = OpLoad %134 
					                            Uniform f32* %136 = OpAccessChain %14 %131 
					                                     f32 %137 = OpLoad %136 
					                                   f32_3 %138 = OpCompositeConstruct %133 %135 %137 
					                                     f32 %139 = OpCompositeExtract %138 0 
					                                     f32 %140 = OpCompositeExtract %138 1 
					                                     f32 %141 = OpCompositeExtract %138 2 
					                                   f32_3 %142 = OpCompositeConstruct %139 %140 %141 
					                                   f32_3 %143 = OpLoad %26 
					                                   f32_3 %144 = OpFMul %142 %143 
					                                   f32_3 %145 = OpLoad %104 
					                                   f32_3 %146 = OpFAdd %144 %145 
					                                   f32_4 %147 = OpLoad %130 
					                                   f32_4 %148 = OpVectorShuffle %147 %146 4 5 6 3 
					                                                  OpStore %130 %148 
					                             Output f32* %151 = OpAccessChain %130 %149 
					                                                  OpStore %151 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
