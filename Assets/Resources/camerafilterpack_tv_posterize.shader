			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat1.x = 256.0 / _Distortion;
					    u_xlat2 = u_xlat10_0 * u_xlat1.xxxx;
					    u_xlat2 = floor(u_xlat2);
					    u_xlat1 = u_xlat2 / u_xlat1.xxxx;
					    u_xlat1 = (-u_xlat10_0) + u_xlat1;
					    SV_Target0 = vec4(vec4(Fade, Fade, Fade, Fade)) * u_xlat1 + u_xlat10_0;
					    return;
					}
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %69 
					          ...
					          read_only Texture2DSampled %39 = OpSampledImage %33 %37 
					                        ...
					                        Private f32* %52 = OpAccessChain %42 %50 
					                               ...
					                               f32_4 %57 = OpFMul %54 %56 
					                                             OpStore %53 %57 
					                               f32_4 %58 = OpLoad %53 
					                               f32_4 %59 = OpExtInst %1 8 %58 
					                                             OpStore %53 %59 
					                               f32_4 %60 = OpLoad %53 
					                               f32_4 %61 = OpLoad %42 
					                               f32_4 %62 = OpVectorShuffle %61 %61 0 0 0 0 
					                               f32_4 %63 = OpFDiv %60 %62 
					                                             OpStore %42 %63 
					                               f32_4 %64 = OpLoad %29 
					                               f32_4 %65 = OpFNegate %64 
					                               f32_4 %66 = OpLoad %42 
					                               f32_4 %67 = OpFAdd %65 %66 
					                                             OpStore %42 %67 
					                        Uniform f32* %71 = OpAccessChain %16 %70 
					                                 f32 %72 = OpLoad %71 
					                        Uniform f32* %73 = OpAccessChain %16 %70 
					                                 f32 %74 = OpLoad %73 
					                        Uniform f32* %75 = OpAccessChain %16 %70 
					                                 f32 %76 = OpLoad %75 
					                        Uniform f32* %77 = OpAccessChain %16 %70 
					                                 f32 %78 = OpLoad %77 
