			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat4.xy = (-u_xlat0.xy) + vec2(_PositionX, _PositionY);
					    ...
					    SV_Target0.xyz = u_xlat10_1.xyz * u_xlat0.xxx;
					    SV_Target0.w = 1.0;
					    return;
					}
					   ...
					   UniformConstant read_only Texture2D* %45 = OpVariable UniformConstant 
					             ...
					             read_only Texture2DSampled %52 = OpSampledImage %46 %50 
					                           ...
					                           Private f32* %67 = OpAccessChain %9 %60 
					                                    f32 %68 = OpLoad %67 
					                           Uniform f32* %70 = OpAccessChain %16 %69 
					                                    f32 %71 = OpLoad %70 
					                                    f32 %72 = OpFNegate %71 
					                                    f32 %73 = OpFAdd %68 %72 
					                           Private f32* %74 = OpAccessChain %9 %60 
					                                                OpStore %74 %73 
					                           Private f32* %75 = OpAccessChain %9 %60 
					                                    f32 %76 = OpLoad %75 
					                                    f32 %78 = OpFMul %76 %77 
					                           Private f32* %79 = OpAccessChain %9 %60 
					                                                OpStore %79 %78 
					                           ...
					                           Private f32* %93 = OpAccessChain %9 %60 
					                                    f32 %94 = OpLoad %93 
					                           Private f32* %95 = OpAccessChain %9 %60 
					                                    f32 %96 = OpLoad %95 
					                                    f32 %97 = OpFMul %94 %96 
					                           Private f32* %98 = OpAccessChain %9 %60 
					                                                OpStore %98 %97 
					                                    f32 %99 = OpLoad %86 
					                                   f32 %100 = OpFNegate %99 
					                          Private f32* %101 = OpAccessChain %9 %60 
					                                   f32 %102 = OpLoad %101 
					                                   f32 %103 = OpFMul %100 %102 
					                                   f32 %104 = OpFAdd %103 %83 
					                          Private f32* %105 = OpAccessChain %9 %60 
					                                                OpStore %105 %104 
					                                 f32_3 %108 = OpLoad %42 
					                                 f32_2 %109 = OpLoad %9 
					                                 f32_3 %110 = OpVectorShuffle %109 %109 0 0 0 
					                                 f32_3 %111 = OpFMul %108 %110 
					                                 f32_4 %112 = OpLoad %107 
					                                 f32_4 %113 = OpVectorShuffle %112 %111 4 5 6 3 
					                                                OpStore %107 %113 
					                           Output f32* %116 = OpAccessChain %107 %114 
					                                                OpStore %116 %83 
					                                                OpReturn
					                                                OpFunctionEnd"
				}
