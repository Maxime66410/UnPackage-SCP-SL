			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_1 = u_xlat10_0 * vec4(-2.0, -2.0, -2.0, -2.0) + vec4(1.0, 1.0, 1.0, 1.0);
					    SV_Target0 = vec4(vec4(_Fade, _Fade, _Fade, _Fade)) * u_xlat16_1 + u_xlat10_0;
					    return;
					}
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %51 
					...
					UniformConstant read_only Texture2D* %32 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %39 = OpSampledImage %33 %37 
					                               ...
					                               f32_4 %49 = OpFAdd %46 %48 
					                                             OpStore %42 %49 
					                        Uniform f32* %54 = OpAccessChain %16 %52 
					                                 f32 %55 = OpLoad %54 
					                        Uniform f32* %56 = OpAccessChain %16 %52 
					                                 f32 %57 = OpLoad %56 
					                        Uniform f32* %58 = OpAccessChain %16 %52 
					                                 f32 %59 = OpLoad %58 
					                        Uniform f32* %60 = OpAccessChain %16 %52 
					                                 f32 %61 = OpLoad %60 
					                               f32_4 %62 = OpCompositeConstruct %55 %57 %59 %61 
					                                 f32 %63 = OpCompositeExtract %62 0 
					                                 f32 %64 = OpCompositeExtract %62 1 
					                                 f32 %65 = OpCompositeExtract %62 2 
					                                 f32 %66 = OpCompositeExtract %62 3 
					                               f32_4 %67 = OpCompositeConstruct %63 %64 %65 %66 
					                               f32_4 %68 = OpLoad %42 
