			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat12.xy = vec2(u_xlat19) * u_xlat1.xy;
					    u_xlat12.x = u_xlat12.y + u_xlat12.x;
					    u_xlat12.x = u_xlat1.z * u_xlat19 + u_xlat12.x;
					    u_xlat0.xy = u_xlat12.xx * vec2(0.333333343, 0.333333343) + u_xlat0.xy;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                               ...
					                                               %1 = OpExtInstImport "GLSL.std.450" 
					                                                      OpMemoryModel Logical GLSL450 
					                                                      OpEntryPoint Fragment %4 "main" %11 %428 
					                              ...
					                              Private f32_2* %306 = OpVariable Private 
					                                Private f32* %317 = OpVariable Private 
					                                       ...
					                                       f32_2 %354 = OpConstantComposite %352 %353 
					                                         ...
					                                         i32 %381 = OpConstant 2 
					                                         u32 %397 = OpConstant 2 
					                                         f32 %408 = OpConstant 3,674022E-40 
					                                       f32_2 %409 = OpConstantComposite %408 %408 
					                              Private f32_3* %413 = OpVariable Private 
					                                             %414 = OpTypeImage %6 Dim2D 0 0 0 1 Unknown 
					                                             %415 = OpTypePointer UniformConstant %414 
					        UniformConstant read_only Texture2D* %416 = OpVariable UniformConstant 
					                                             %418 = OpTypeSampler 
					                                             %419 = OpTypePointer UniformConstant %418 
					                    UniformConstant sampler* %420 = OpVariable UniformConstant 
					                                             %422 = OpTypeSampledImage %414 
					                                             %427 = OpTypePointer Output %13 
					                               Output f32_4* %428 = OpVariable Output 
					                                         u32 %432 = OpConstant 3 
					                                             %433 = OpTypePointer Output %6 
					                                             %436 = OpTypePointer Private %17 
					                                Private i32* %437 = OpVariable Private 
					                               Private bool* %438 = OpVariable Private 
					                                          void %4 = OpFunction None %3 
					                                               %5 = OpLabel 
					                              ...
					                              Uniform f32_4* %382 = OpAccessChain %16 %381 
					                                       ...
					                                       f32_2 %390 = OpFMul %387 %389 
					                                                      OpStore %28 %390 
					                                Private f32* %391 = OpAccessChain %28 %58 
					                                         f32 %392 = OpLoad %391 
					                                Private f32* %393 = OpAccessChain %28 %51 
					                                         f32 %394 = OpLoad %393 
					                                         f32 %395 = OpFAdd %392 %394 
					                                Private f32* %396 = OpAccessChain %28 %51 
					                                                      OpStore %396 %395 
					                                Private f32* %398 = OpAccessChain %42 %397 
					                                         f32 %399 = OpLoad %398 
					                                         f32 %400 = OpLoad %80 
					                                         f32 %401 = OpFMul %399 %400 
					                                Private f32* %402 = OpAccessChain %28 %51 
					                                         f32 %403 = OpLoad %402 
					                                         f32 %404 = OpFAdd %401 %403 
					                                Private f32* %405 = OpAccessChain %28 %51 
					                                                      OpStore %405 %404 
					                                       f32_2 %406 = OpLoad %28 
					                                       f32_2 %407 = OpVectorShuffle %406 %406 0 0 
					                                       f32_2 %410 = OpFMul %407 %409 
					                                       f32_2 %411 = OpLoad %9 
					                                       f32_2 %412 = OpFAdd %410 %411 
					                                                      OpStore %9 %412 
					                         read_only Texture2D %417 = OpLoad %416 
					                                     sampler %421 = OpLoad %420 
					                  read_only Texture2DSampled %423 = OpSampledImage %417 %421 
					                                       f32_2 %424 = OpLoad %9 
					                                       f32_4 %425 = OpImageSampleImplicitLod %423 %424 
					                                       f32_3 %426 = OpVectorShuffle %425 %425 0 1 2 
					                                                      OpStore %413 %426 
					                                       f32_3 %429 = OpLoad %413 
					                                       f32_4 %430 = OpLoad %428 
					                                       f32_4 %431 = OpVectorShuffle %430 %429 4 5 6 3 
					                                                      OpStore %428 %431 
					                                 Output f32* %434 = OpAccessChain %428 %432 
					                                                      OpStore %434 %71 
					                                                      OpReturn
					                                                      OpFunctionEnd"
				}
