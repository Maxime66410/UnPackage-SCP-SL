			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(-20.197731, -20.197731, -20.197731);
					    u_xlat16_0.xyz = exp2(u_xlat16_0.xyz);
					    u_xlat16_0.xyz = u_xlat16_0.xyz + vec3(1.0, 1.0, 1.0);
					    u_xlat16_0.xyz = vec3(1.0, 1.0, 1.0) / u_xlat16_0.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %12 %81 
					...
					UniformConstant read_only Texture2D* %34 = OpVariable UniformConstant 
					            ...
					            UniformConstant sampler* %38 = OpVariable UniformConstant 
					                      ...
					                      Private f32_3* %46 = OpVariable Private 
					                               ...
					                               f32_3 %59 = OpConstantComposite %58 %58 %58 
					                                 i32 %66 = OpConstant 0 
					                                     %67 = OpTypePointer Uniform %6 
					                                     %80 = OpTypePointer Output %14 
					          ...
					          read_only Texture2DSampled %41 = OpSampledImage %35 %39 
					                               ...
					                               f32_3 %54 = OpFMul %51 %53 
					                                             OpStore %46 %54 
					                               f32_3 %55 = OpLoad %46 
					                               f32_3 %56 = OpExtInst %1 29 %55 
					                                             OpStore %46 %56 
					                               f32_3 %57 = OpLoad %46 
					                               f32_3 %60 = OpFAdd %57 %59 
					                                             OpStore %46 %60 
					                               f32_3 %61 = OpLoad %46 
					                               f32_3 %62 = OpFDiv %59 %61 
					                                             OpStore %46 %62 
					                               f32_3 %63 = OpLoad %46 
					                               f32_3 %64 = OpExtInst %1 30 %63 
					                                             OpStore %46 %64 
					                               f32_3 %65 = OpLoad %46 
					                        Uniform f32* %68 = OpAccessChain %17 %66 
					                                 f32 %69 = OpLoad %68 
					                        Uniform f32* %70 = OpAccessChain %17 %66 
					                                 f32 %71 = OpLoad %70 
					                        Uniform f32* %72 = OpAccessChain %17 %66 
					                                 f32 %73 = OpLoad %72 
					                               ...
					                               f32_3 %79 = OpFMul %65 %78 
					                                             OpStore %9 %79 
					                               f32_3 %82 = OpLoad %9 
					                               f32_3 %83 = OpExtInst %1 29 %82 
					                               f32_4 %84 = OpLoad %81 
					                               f32_4 %85 = OpVectorShuffle %84 %83 4 5 6 3 
					                                             OpStore %81 %85 
					                         Output f32* %89 = OpAccessChain %81 %87 
					                                             OpStore %89 %58 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
