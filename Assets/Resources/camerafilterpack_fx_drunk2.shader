			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %38 %118 
					...
					UniformConstant read_only Texture2D* %67 = OpVariable UniformConstant 
					                     ...
					                     Private f32_4* %101 = OpVariable Private 
					                      ...
					                      Output f32_4* %118 = OpVariable Output 
					                        ...
					                        Private f32* %33 = OpAccessChain %9 %32 
					                                             OpStore %33 %31 
					                        Private f32* %35 = OpAccessChain %9 %21 
					                                             OpStore %35 %34 
					          ...
					          read_only Texture2DSampled %74 = OpSampledImage %68 %72 
					                               ...
					                               f32_4 %76 = OpImageSampleImplicitLod %74 %75 
					                                             OpStore %64 %76 
					                 read_only Texture2D %78 = OpLoad %67 
					                             sampler %79 = OpLoad %71 
					          ...
					          read_only Texture2DSampled %87 = OpSampledImage %85 %86 
					                               ...
					                               f32_4 %94 = OpFAdd %92 %93 
					                                             OpStore %91 %94 
					                 read_only Texture2D %95 = OpLoad %67 
					                             sampler %96 = OpLoad %71 
					          read_only Texture2DSampled %97 = OpSampledImage %95 %96 
					                              ...
					                              f32_4 %100 = OpImageSampleImplicitLod %97 %99 
					                                             OpStore %77 %100 
					                read_only Texture2D %102 = OpLoad %67 
					                            sampler %103 = OpLoad %71 
