			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                         ...
					                                         %1 = OpExtInstImport "GLSL.std.450" 
					                                                OpMemoryModel Logical GLSL450 
					                                                OpEntryPoint Fragment %4 "main" %12 %93 
					   ...
					   UniformConstant read_only Texture2D* %34 = OpVariable UniformConstant 
					               ...
					               UniformConstant sampler* %38 = OpVariable UniformConstant 
					                         ...
					                         Private f32_3* %46 = OpVariable Private 
					                           ...
					                           Private f32* %55 = OpVariable Private 
					                                  ...
					                                  f32_3 %60 = OpConstantComposite %57 %58 %59 
					                                    i32 %71 = OpConstant 1 
					             ...
					             read_only Texture2DSampled %41 = OpSampledImage %35 %39 
					                           ...
					                           Uniform f32* %50 = OpAccessChain %17 %48 
					                                  ...
					                                  f32_3 %53 = OpFMul %47 %52 
					                                                OpStore %46 %53 
					                                  f32_3 %56 = OpLoad %46 
					                                    f32 %61 = OpDot %56 %60 
					                                                OpStore %55 %61 
					                                  f32_3 %62 = OpLoad %31 
					                           Uniform f32* %63 = OpAccessChain %17 %48 
					                                    f32 %64 = OpLoad %63 
					                           ...
					                           Uniform f32* %72 = OpAccessChain %17 %71 
					                                    f32 %73 = OpLoad %72 
					                           Uniform f32* %74 = OpAccessChain %17 %71 
					                                    f32 %75 = OpLoad %74 
					                           Uniform f32* %76 = OpAccessChain %17 %71 
					                                    f32 %77 = OpLoad %76 
					                           ...
					                           Uniform f32* %95 = OpAccessChain %17 %94 
					                                    f32 %96 = OpLoad %95 
					                           Uniform f32* %97 = OpAccessChain %17 %94 
					                                    f32 %98 = OpLoad %97 
					                           Uniform f32* %99 = OpAccessChain %17 %94 
					                                   f32 %100 = OpLoad %99 
					                                 ...
					                                 f32_4 %112 = OpVectorShuffle %111 %110 4 5 6 3 
					                                                OpStore %93 %112 
					                           Output f32* %117 = OpAccessChain %93 %115 
					                                                OpStore %117 %113 
					                                                OpReturn
					                                                OpFunctionEnd"
				}
