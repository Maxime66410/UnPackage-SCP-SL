			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = u_xlat10_1.xyz * vec3(vec3(_Value2, _Value2, _Value2)) + u_xlat10_0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}
					...
					UniformConstant read_only Texture2D* %28 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %32 = OpSampledImage %29 %31 
					                        ...
					                        Uniform f32* %45 = OpAccessChain %41 %43 
					                                 f32 %46 = OpLoad %45 
					                        Uniform f32* %47 = OpAccessChain %41 %43 
					                                 f32 %48 = OpLoad %47 
					                        Uniform f32* %49 = OpAccessChain %41 %43 
					                                 f32 %50 = OpLoad %49 
					                               f32_3 %51 = OpCompositeConstruct %46 %48 %50 
					                                 f32 %52 = OpCompositeExtract %51 0 
					                                 f32 %53 = OpCompositeExtract %51 1 
					                                 f32 %54 = OpCompositeExtract %51 2 
					                               f32_3 %55 = OpCompositeConstruct %52 %53 %54 
					                               f32_3 %56 = OpFMul %38 %55 
					                               f32_3 %57 = OpLoad %9 
					                               f32_3 %58 = OpFAdd %56 %57 
					                               f32_4 %59 = OpLoad %37 
					                               f32_4 %60 = OpVectorShuffle %59 %58 4 5 6 3 
					                                             OpStore %37 %60 
					                         Output f32* %65 = OpAccessChain %37 %63 
					                                             OpStore %65 %61 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					{
					    u_xlat10_0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat1.x = _Amount / _ScreenParams.y;
					    u_xlat1.y = 0.0;
					    u_xlat7.xy = (-u_xlat1.xy) + vs_TEXCOORD0.xy;
					    u_xlat1.xy = u_xlat1.xy + vs_TEXCOORD0.xy;
					    u_xlat10_2 = texture(_MainTex, u_xlat1.xy);
					   ...
					   UniformConstant read_only Texture2D* %41 = OpVariable UniformConstant 
					             ...
					             read_only Texture2DSampled %48 = OpSampledImage %42 %46 
					                           ...
					                           Uniform f32* %59 = OpAccessChain %13 %58 
					                                    ...
					                                    f32 %61 = OpFNegate %60 
					                                    f32 %62 = OpFAdd %57 %61 
					                           Private f32* %63 = OpAccessChain %9 %25 
					                                                OpStore %63 %62 
					                           Uniform f32* %67 = OpAccessChain %13 %66 
					                                    ...
					                                    f32 %69 = OpFDiv %65 %68 
					                                                OpStore %64 %69 
					                                    f32 %70 = OpLoad %64 
					                           Private f32* %71 = OpAccessChain %9 %25 
					                                    f32 %72 = OpLoad %71 
					                                    f32 %73 = OpFMul %70 %72 
					                           Private f32* %74 = OpAccessChain %9 %25 
					                                                OpStore %74 %73 
					                           Private f32* %75 = OpAccessChain %9 %25 
					                                    f32 %76 = OpLoad %75 
					                                    f32 %77 = OpExtInst %1 43 %76 %28 %65 
					                           Private f32* %78 = OpAccessChain %9 %25 
					                                                OpStore %78 %77 
					                           Private f32* %79 = OpAccessChain %9 %25 
					                                    f32 %80 = OpLoad %79 
					                                    f32 %82 = OpFMul %80 %81 
					                                    f32 %84 = OpFAdd %82 %83 
					                                                OpStore %64 %84 
					                           Private f32* %85 = OpAccessChain %9 %25 
					                                    f32 %86 = OpLoad %85 
					                           Private f32* %87 = OpAccessChain %9 %25 
					                                    f32 %88 = OpLoad %87 
					                                    f32 %89 = OpFMul %86 %88 
					                           Private f32* %90 = OpAccessChain %9 %25 
					                                                OpStore %90 %89 
					                                  f32_2 %93 = OpLoad %9 
