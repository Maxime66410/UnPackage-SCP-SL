			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = vec3(u_xlat6) + vec3(1.0, 0.666666687, 0.333333343);
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %98 
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					            ...
					            UniformConstant sampler* %37 = OpVariable UniformConstant 
					                      ...
					                      Private f32_3* %67 = OpVariable Private 
					                               ...
					                               f32_3 %72 = OpConstantComposite %56 %70 %71 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Uniform f32* %61 = OpAccessChain %16 %59 
					                               ...
					                               f32_3 %73 = OpFAdd %69 %72 
					                                             OpStore %67 %73 
					                               f32_3 %74 = OpLoad %67 
					                               f32_3 %75 = OpExtInst %1 10 %74 
					                                             OpStore %67 %75 
					                               f32_3 %76 = OpLoad %67 
					                               ...
					                               f32_3 %82 = OpFAdd %79 %81 
					                                             OpStore %67 %82 
					                               f32_3 %83 = OpLoad %67 
					                               f32_3 %84 = OpExtInst %1 4 %83 
					                               f32_3 %87 = OpFAdd %84 %86 
					                                             OpStore %67 %87 
					                               f32_3 %88 = OpLoad %67 
					                               f32_3 %90 = OpCompositeConstruct %89 %89 %89 
					                               f32_3 %91 = OpCompositeConstruct %56 %56 %56 
					                       ...
					                       Uniform f32* %100 = OpAccessChain %16 %99 
					                                f32 %101 = OpLoad %100 
					                       Uniform f32* %102 = OpAccessChain %16 %99 
					                                f32 %103 = OpLoad %102 
					                       Uniform f32* %104 = OpAccessChain %16 %99 
					                                f32 %105 = OpLoad %104 
					                              ...
					                              f32_4 %116 = OpVectorShuffle %115 %114 4 5 6 3 
					                                             OpStore %98 %116 
					                        Output f32* %120 = OpAccessChain %98 %118 
					                                             OpStore %120 %56 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
