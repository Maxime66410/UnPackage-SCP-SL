			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = (-u_xlat0.xyz) * u_xlat1.xyz + u_xlat2.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %134 
					     ...
					     UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					                 UniformConstant sampler* %79 = OpVariable UniformConstant 
					                          ...
					                          Private f32_3* %104 = OpVariable Private 
					                                         %133 = OpTypePointer Output %11 
					                           Output f32_4* %134 = OpVariable Output 
					                                     i32 %135 = OpConstant 0 
					                                     u32 %153 = OpConstant 3 
					                                         %154 = OpTypePointer Output %9 
					                                      void %4 = OpFunction None %3 
					                                           %5 = OpLabel 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                   ...
					                                   f32_3 %132 = OpFAdd %130 %131 
					                                                  OpStore %26 %132 
					                            Uniform f32* %136 = OpAccessChain %14 %135 
					                                     f32 %137 = OpLoad %136 
					                            Uniform f32* %138 = OpAccessChain %14 %135 
					                                     f32 %139 = OpLoad %138 
					                            Uniform f32* %140 = OpAccessChain %14 %135 
					                                     f32 %141 = OpLoad %140 
					                                   ...
					                                   f32_3 %149 = OpLoad %104 
					                                   f32_3 %150 = OpFAdd %148 %149 
					                                   f32_4 %151 = OpLoad %134 
					                                   f32_4 %152 = OpVectorShuffle %151 %150 4 5 6 3 
					                                                  OpStore %134 %152 
					                             Output f32* %155 = OpAccessChain %134 %153 
					                                                  OpStore %155 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
