			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat10_0 = texture(_MainTex, u_xlat5.xy);
					...
					Uniform struct {f32_4; f32_4; f32; f32_4; f32; f32; f32; f32; f32; f32_4;}* %40 = OpVariable Uniform 
					        ...
					        UniformConstant read_only Texture2D* %281 = OpVariable UniformConstant 
					                    UniformConstant sampler* %283 = OpVariable UniformConstant 
					                                       ...
					                                       f32_4 %298 = OpConstantComposite %297 %297 %297 %297 
					                                          void %4 = OpFunction None %3 
					                                               %5 = OpLabel 
					                  ...
					                  read_only Texture2DSampled %285 = OpSampledImage %282 %284 
					                                       f32_2 %286 = OpLoad %61 
					                                       f32_4 %287 = OpImageSampleImplicitLod %285 %286 
					                                                      OpStore %169 %287 
					                                Private f32* %288 = OpAccessChain %89 %50 
					                                         f32 %289 = OpLoad %288 
					                                Uniform f32* %291 = OpAccessChain %40 %290 
					                                         f32 %292 = OpLoad %291 
					                                         f32 %293 = OpFMul %289 %292 
					                                Private f32* %294 = OpAccessChain %89 %34 
					                                                      OpStore %294 %293 
					                                       f32_4 %295 = OpLoad %89 
					                                       f32_4 %296 = OpVectorShuffle %295 %295 0 0 0 0 
					                                       f32_4 %299 = OpFMul %296 %298 
					                                       f32_4 %300 = OpLoad %169 
					                                       f32_4 %301 = OpFAdd %299 %300 
					                                                      OpStore %89 %301 
					                                       f32_4 %302 = OpLoad %89 
					                                       f32_4 %303 = OpLoad %159 
