			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = (bool(u_xlatb9)) ? u_xlat0.xyz : u_xlat1.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %161 
					                 ...
					                 UniformConstant sampler* %79 = OpVariable UniformConstant 
					                          ...
					                          Private f32_3* %104 = OpVariable Private 
					                           ...
					                           Private bool* %142 = OpVariable Private 
					                                         %148 = OpTypePointer Function %24 
					                                         %160 = OpTypePointer Output %11 
					                           Output f32_4* %161 = OpVariable Output 
					                                     i32 %162 = OpConstant 0 
					                                     u32 %180 = OpConstant 3 
					                                         %181 = OpTypePointer Output %9 
					                                      void %4 = OpFunction None %3 
					                                           %5 = OpLabel 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                   ...
					                                   f32_3 %119 = OpFAdd %117 %118 
					                                                  OpStore %104 %119 
					                            Private f32* %120 = OpAccessChain %97 %18 
					                                     f32 %121 = OpLoad %120 
					                            Private f32* %123 = OpAccessChain %97 %122 
					                                     f32 %124 = OpLoad %123 
					                            ...
					                            Private f32* %126 = OpAccessChain %97 %59 
					                                     ...
					                                     f32 %129 = OpFAdd %127 %128 
					                                                  OpStore %91 %129 
					                            Private f32* %130 = OpAccessChain %104 %18 
					                                     f32 %131 = OpLoad %130 
					                            Private f32* %132 = OpAccessChain %104 %122 
					                                     f32 %133 = OpLoad %132 
					                                     f32 %134 = OpFAdd %131 %133 
					                            Private f32* %135 = OpAccessChain %26 %122 
					                                                  OpStore %135 %134 
					                            Private f32* %136 = OpAccessChain %104 %59 
					                                     f32 %137 = OpLoad %136 
					                            Private f32* %138 = OpAccessChain %26 %122 
					                                     f32 %139 = OpLoad %138 
					                                     f32 %140 = OpFAdd %137 %139 
					                            Private f32* %141 = OpAccessChain %26 %122 
					                                                  OpStore %141 %140 
					                                     f32 %143 = OpLoad %91 
					                            Private f32* %144 = OpAccessChain %26 %122 
					                                     f32 %145 = OpLoad %144 
					                                    bool %146 = OpFOrdLessThan %143 %145 
					                                                  OpStore %142 %146 
					                                    bool %147 = OpLoad %142 
					                                                  OpSelectionMerge %151 None 
					                                                  OpBranchConditional %147 %150 %153 
					                                         %150 = OpLabel 
					                                   f32_3 %152 = OpLoad %104 
					                                                  OpStore %149 %152 
					                                                  OpBranch %151 
					                                         %153 = OpLabel 
					                                   f32_3 %154 = OpLoad %97 
					                                                  ...
					                                                  OpBranch %151 
					                                         %151 = OpLabel 
					                                   f32_3 %155 = OpLoad %149 
					                                                  OpStore %26 %155 
					                                   f32_3 %156 = OpLoad %104 
					                            ...
					                            Uniform f32* %167 = OpAccessChain %14 %162 
					                                   ...
					                                   f32_3 %176 = OpLoad %104 
					                                   f32_3 %177 = OpFAdd %175 %176 
					                                   f32_4 %178 = OpLoad %161 
					                                   f32_4 %179 = OpVectorShuffle %178 %177 4 5 6 3 
					                                                  OpStore %161 %179 
					                             Output f32* %182 = OpAccessChain %161 %180 
					                                                  OpStore %182 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = (bool(u_xlatb9)) ? u_xlat0.xyz : u_xlat2.xyz;
					    u_xlat1.xyz = (-u_xlat0.xyz) + u_xlat1.xyz;
					    SV_Target0.xyz = vec3(vec3(_Value, _Value, _Value)) * u_xlat1.xyz + u_xlat0.xyz;
					    SV_Target0.w = 1.0;
					    return;
