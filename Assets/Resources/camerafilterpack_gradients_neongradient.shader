			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %114 
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Private f32* %74 = OpAccessChain %67 %73 
					                               ...
					                               f32_2 %92 = OpCompositeConstruct %56 %56 
					                               f32_2 %93 = OpExtInst %1 43 %89 %91 %92 
					                               f32_3 %94 = OpLoad %75 
					                               f32_3 %95 = OpVectorShuffle %94 %93 3 1 4 
					                                             OpStore %75 %95 
					                        Private f32* %96 = OpAccessChain %67 %73 
					                                 f32 %97 = OpLoad %96 
					                       ...
					                       Private f32* %104 = OpAccessChain %75 %103 
					                                             OpStore %104 %102 
					                       Private f32* %105 = OpAccessChain %75 %103 
					                                f32 %106 = OpLoad %105 
					                                f32 %107 = OpExtInst %1 43 %106 %90 %56 
					                       Private f32* %108 = OpAccessChain %75 %103 
					                                             OpStore %108 %107 
					                              f32_3 %109 = OpLoad %30 
					                              ...
					                              f32_3 %112 = OpFAdd %110 %111 
					                                             OpStore %67 %112 
					                       Uniform f32* %116 = OpAccessChain %16 %115 
					                                f32 %117 = OpLoad %116 
					                       Uniform f32* %118 = OpAccessChain %16 %115 
					                                f32 %119 = OpLoad %118 
					                       Uniform f32* %120 = OpAccessChain %16 %115 
					                                f32 %121 = OpLoad %120 
					                              ...
					                              f32_4 %132 = OpVectorShuffle %131 %130 4 5 6 3 
					                                             OpStore %114 %132 
					                        Output f32* %135 = OpAccessChain %114 %133 
					                                             OpStore %135 %56 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
