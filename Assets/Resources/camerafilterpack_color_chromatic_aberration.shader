			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %28 %62 
					...
					UniformConstant read_only Texture2D* %50 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %57 = OpSampledImage %51 %55 
					                               ...
					                               f32_2 %63 = OpLoad %47 
					                               f32_4 %64 = OpLoad %62 
					                               f32_4 %65 = OpVectorShuffle %64 %63 0 4 2 5 
					                                             OpStore %62 %65 
					                 read_only Texture2D %66 = OpLoad %50 
					                             sampler %67 = OpLoad %54 
					          read_only Texture2DSampled %68 = OpSampledImage %66 %67 
					                        ...
					                        Private f32* %73 = OpAccessChain %9 %24 
					                                             OpStore %73 %72 
					                 read_only Texture2D %74 = OpLoad %50 
					                             sampler %75 = OpLoad %54 
					          read_only Texture2DSampled %76 = OpSampledImage %74 %75 
					                               ...
					                               f32_4 %79 = OpImageSampleImplicitLod %76 %78 
					                                 f32 %81 = OpCompositeExtract %79 2 
					                        Private f32* %82 = OpAccessChain %9 %20 
					                                             OpStore %82 %81 
					                               f32_2 %83 = OpLoad %9 
					                               f32_4 %84 = OpLoad %62 
					                               f32_4 %85 = OpVectorShuffle %84 %83 4 1 5 3 
					                                             OpStore %62 %85 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
