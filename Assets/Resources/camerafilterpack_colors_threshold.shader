			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    SV_Target0 = u_xlat0.xxxx * vec4(u_xlat1);
					    return;
					}
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %11 %85 
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Private f32* %60 = OpAccessChain %9 %58 
					                                 f32 %61 = OpLoad %60 
					                                 f32 %63 = OpFMul %61 %62 
					                        Private f32* %64 = OpAccessChain %9 %58 
					                                             OpStore %64 %63 
					                        Private f32* %65 = OpAccessChain %9 %58 
					                                 f32 %66 = OpLoad %65 
					                                 f32 %69 = OpExtInst %1 43 %66 %67 %68 
					                        Private f32* %70 = OpAccessChain %9 %58 
					                                             OpStore %70 %69 
					                        Private f32* %72 = OpAccessChain %9 %58 
					                                 f32 %73 = OpLoad %72 
					                                 f32 %75 = OpFMul %73 %74 
					                                 f32 %77 = OpFAdd %75 %76 
					                                             OpStore %71 %77 
					                        Private f32* %78 = OpAccessChain %9 %58 
					                                 f32 %79 = OpLoad %78 
					                        Private f32* %80 = OpAccessChain %9 %58 
					                                 f32 %81 = OpLoad %80 
					                                 f32 %82 = OpFMul %79 %81 
					                        Private f32* %83 = OpAccessChain %9 %58 
					                                             OpStore %83 %82 
					                               f32_2 %86 = OpLoad %9 
					                               f32_4 %87 = OpVectorShuffle %86 %86 0 0 0 0 
					                                 f32 %88 = OpLoad %71 
					                               f32_4 %89 = OpCompositeConstruct %88 %88 %88 %88 
