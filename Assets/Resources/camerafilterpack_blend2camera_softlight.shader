			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat10_1 = texture(_MainTex2, u_xlat6.xy);
					    u_xlat10_2 = texture(_MainTex, u_xlat6.xy);
					    u_xlat16_6.xyz = u_xlat10_1.xyz + (-u_xlat10_2.xyz);
					    u_xlat1.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat10_2.xyz;
					    u_xlat0.xyz = vec3(vec3(_Value2, _Value2, _Value2)) * u_xlat16_6.xyz + u_xlat10_2.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %281 
					     ...
					     UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					                 UniformConstant sampler* %79 = OpVariable UniformConstant 
					                          ...
					                          Private f32_3* %141 = OpVariable Private 
					                                         %161 = OpTypeVector %6 3 
					                                         %162 = OpTypePointer Private %161 
					                         Private bool_3* %163 = OpVariable Private 
					                                     f32 %166 = OpConstant 3,674022E-40 
					                                   f32_4 %167 = OpConstantComposite %166 %166 %166 %22 
					                                         %168 = OpTypeVector %6 4 
					                                         %171 = OpTypePointer Function %24 
					                                     u32 %174 = OpConstant 0 
					                         Private bool_3* %212 = OpVariable Private 
					                                     f32 %215 = OpConstant 3,674022E-40 
					                                   f32_4 %216 = OpConstantComposite %215 %215 %215 %22 
					                                   f32_3 %221 = OpConstantComposite %47 %47 %47 
					                          Private f32_3* %223 = OpVariable Private 
					                                         %280 = OpTypePointer Output %11 
					                           Output f32_4* %281 = OpVariable Output 
					                                     i32 %282 = OpConstant 0 
					                                     u32 %300 = OpConstant 3 
					                                         %301 = OpTypePointer Output %9 
					                                      void %4 = OpFunction None %3 
					                                           %5 = OpLabel 
					                            Function f32* %51 = OpVariable Function 
					                         Function f32_3* %172 = OpVariable Function 
					                           Function f32* %177 = OpVariable Function 
					                           Function f32* %189 = OpVariable Function 
					                           Function f32* %201 = OpVariable Function 
					                         Function f32_3* %237 = OpVariable Function 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                   ...
					                                   f32_3 %157 = OpLoad %141 
					                                   f32_3 %158 = OpFMul %156 %157 
					                                   f32_3 %159 = OpLoad %97 
					                                   f32_3 %160 = OpFAdd %158 %159 
					                                                  OpStore %133 %160 
					                                   f32_3 %164 = OpLoad %97 
					                                   f32_4 %165 = OpVectorShuffle %164 %164 0 1 2 0 
					                                  bool_4 %169 = OpFOrdLessThan %165 %167 
					                                  bool_3 %170 = OpVectorShuffle %169 %169 0 1 2 
					                                                  OpStore %163 %170 
					                                   f32_3 %173 = OpLoad %26 
					                                                  OpStore %172 %173 
					                           Private bool* %175 = OpAccessChain %163 %174 
					                                    bool %176 = OpLoad %175 
					                                                  OpSelectionMerge %179 None 
					                                                  OpBranchConditional %176 %178 %182 
					                                         %178 = OpLabel 
					                            Private f32* %180 = OpAccessChain %26 %174 
					                                     f32 %181 = OpLoad %180 
					                                                  OpStore %177 %181 
					                                                  OpBranch %179 
					                                         %182 = OpLabel 
					                            Private f32* %183 = OpAccessChain %133 %174 
					                                     f32 %184 = OpLoad %183 
					                                                  OpStore %177 %184 
					                                                  OpBranch %179 
					                                         %179 = OpLabel 
					                                     f32 %185 = OpLoad %177 
					                           Function f32* %186 = OpAccessChain %172 %174 
					                                                  OpStore %186 %185 
					                           Private bool* %187 = OpAccessChain %163 %18 
					                                    bool %188 = OpLoad %187 
					                                                  OpSelectionMerge %191 None 
					                                                  OpBranchConditional %188 %190 %194 
					                                         %190 = OpLabel 
					                            Private f32* %192 = OpAccessChain %26 %18 
					                                     f32 %193 = OpLoad %192 
					                                                  OpStore %189 %193 
					                                                  OpBranch %191 
					                                         %194 = OpLabel 
					                            Private f32* %195 = OpAccessChain %133 %18 
					                                     f32 %196 = OpLoad %195 
					                                                  OpStore %189 %196 
					                                                  OpBranch %191 
					                                         %191 = OpLabel 
					                                     f32 %197 = OpLoad %189 
					                           Function f32* %198 = OpAccessChain %172 %18 
					                                                  OpStore %198 %197 
					                           Private bool* %199 = OpAccessChain %163 %59 
					                                    bool %200 = OpLoad %199 
					                                                  OpSelectionMerge %203 None 
					                                                  OpBranchConditional %200 %202 %206 
					                                         %202 = OpLabel 
					                            Private f32* %204 = OpAccessChain %26 %59 
					                                     f32 %205 = OpLoad %204 
					                                                  OpStore %201 %205 
					                                                  OpBranch %203 
					                                         %206 = OpLabel 
					                            Private f32* %207 = OpAccessChain %133 %59 
					                                     f32 %208 = OpLoad %207 
					                                                  OpStore %201 %208 
					                                                  OpBranch %203 
					                                         %203 = OpLabel 
					                                     f32 %209 = OpLoad %201 
					                           Function f32* %210 = OpAccessChain %172 %59 
					                                                  OpStore %210 %209 
					                                   f32_3 %211 = OpLoad %172 
					                                                  OpStore %26 %211 
					                                   f32_3 %213 = OpLoad %104 
					                                   f32_4 %214 = OpVectorShuffle %213 %213 0 1 2 0 
					                                  bool_4 %217 = OpFOrdLessThan %214 %216 
					                                  bool_3 %218 = OpVectorShuffle %217 %217 0 1 2 
					                                                  OpStore %212 %218 
					                                   f32_3 %219 = OpLoad %97 
					                                   f32_3 %220 = OpFNegate %219 
					                                   f32_3 %222 = OpFAdd %220 %221 
					                                                  OpStore %141 %222 
					                                   f32_3 %224 = OpLoad %104 
					                                   f32_3 %225 = OpFNegate %224 
					                                   f32_3 %226 = OpFMul %225 %136 
					                                   f32_3 %227 = OpFAdd %226 %221 
					                                                  OpStore %223 %227 
					                                   f32_3 %228 = OpLoad %97 
					                                   f32_3 %229 = OpLoad %223 
					                                   f32_3 %230 = OpFMul %228 %229 
					                                                  OpStore %223 %230 
					                                   f32_3 %231 = OpLoad %223 
					                                   f32_3 %232 = OpFNegate %231 
					                                   f32_3 %233 = OpLoad %141 
					                                   ...
					                                   f32_3 %238 = OpLoad %26 
					                                                  OpStore %237 %238 
					                           Private bool* %239 = OpAccessChain %212 %174 
					                                    bool %240 = OpLoad %239 
					                                                  OpSelectionMerge %243 None 
					                                                  OpBranchConditional %240 %242 %246 
					                                         %242 = OpLabel 
					                            Private f32* %244 = OpAccessChain %97 %174 
					                                     f32 %245 = OpLoad %244 
					                                                  OpStore %241 %245 
					                                                  OpBranch %243 
					                                         %246 = OpLabel 
					                            Private f32* %247 = OpAccessChain %26 %174 
					                                     f32 %248 = OpLoad %247 
					                                                  OpStore %241 %248 
					                                                  OpBranch %243 
					                                         %243 = OpLabel 
					                                     f32 %249 = OpLoad %241 
					                           Function f32* %250 = OpAccessChain %237 %174 
					                                                  OpStore %250 %249 
					                           Private bool* %251 = OpAccessChain %212 %18 
					                                    bool %252 = OpLoad %251 
					                            ...
					                            Private f32* %256 = OpAccessChain %97 %18 
					                                     f32 %257 = OpLoad %256 
					                                                  ...
					                                                  OpBranch %255 
					                                         %258 = OpLabel 
					                            Private f32* %259 = OpAccessChain %26 %18 
					                                     f32 %260 = OpLoad %259 
					                                                  OpStore %253 %260 
					                                                  OpBranch %255 
					                                         %255 = OpLabel 
					                                     f32 %261 = OpLoad %253 
					                           Function f32* %262 = OpAccessChain %237 %18 
					                                                  OpStore %262 %261 
					                           Private bool* %263 = OpAccessChain %212 %59 
					                                    bool %264 = OpLoad %263 
					                                                  OpSelectionMerge %267 None 
					                                                  OpBranchConditional %264 %266 %270 
					                                         %266 = OpLabel 
					                            Private f32* %268 = OpAccessChain %97 %59 
					                                     f32 %269 = OpLoad %268 
					                                                  OpStore %265 %269 
					                                                  OpBranch %267 
					                                         %270 = OpLabel 
					                            Private f32* %271 = OpAccessChain %26 %59 
					                                     f32 %272 = OpLoad %271 
					                                                  OpStore %265 %272 
					                                                  OpBranch %267 
					                                         %267 = OpLabel 
					                                     f32 %273 = OpLoad %265 
					                           Function f32* %274 = OpAccessChain %237 %59 
					                                                  OpStore %274 %273 
					                                   f32_3 %275 = OpLoad %237 
					                                                  OpStore %26 %275 
					                                   f32_3 %276 = OpLoad %104 
					                                   f32_3 %277 = OpFNegate %276 
					                                   f32_3 %278 = OpLoad %26 
					                                   f32_3 %279 = OpFAdd %277 %278 
					                                                  OpStore %26 %279 
					                            Uniform f32* %283 = OpAccessChain %14 %282 
					                                     f32 %284 = OpLoad %283 
					                            Uniform f32* %285 = OpAccessChain %14 %282 
					                                     f32 %286 = OpLoad %285 
					                            Uniform f32* %287 = OpAccessChain %14 %282 
					                                     f32 %288 = OpLoad %287 
					                                   ...
					                                   f32_3 %296 = OpLoad %104 
					                                   f32_3 %297 = OpFAdd %295 %296 
					                                   f32_4 %298 = OpLoad %281 
					                                   f32_4 %299 = OpVectorShuffle %298 %297 4 5 6 3 
					                                                  OpStore %281 %299 
					                             Output f32* %302 = OpAccessChain %281 %300 
					                                                  OpStore %302 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = vec3(u_xlat18) * u_xlat16_0.xyz + u_xlat10_1.xyz;
