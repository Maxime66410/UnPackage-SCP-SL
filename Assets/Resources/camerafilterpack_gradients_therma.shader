					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Uniform f32* %61 = OpAccessChain %16 %59 
					                               ...
					                               f32_3 %75 = OpVectorShuffle %74 %73 3 4 2 
					                                             OpStore %67 %75 
					                        Private f32* %78 = OpAccessChain %67 %77 
					                                 f32 %79 = OpLoad %78 
					                        Private f32* %80 = OpAccessChain %67 %77 
					                                             OpStore %80 %79 
					                        Private f32* %81 = OpAccessChain %67 %77 
					                                 f32 %82 = OpLoad %81 
					                                 f32 %84 = OpExtInst %1 43 %82 %83 %56 
					                        Private f32* %85 = OpAccessChain %67 %77 
					                                             OpStore %85 %84 
					                        Private f32* %87 = OpAccessChain %67 %77 
					                                 f32 %88 = OpLoad %87 
					                                 f32 %89 = OpFMul %88 %54 
					                                 f32 %91 = OpFAdd %89 %90 
					                                             OpStore %86 %91 
					                        Private f32* %92 = OpAccessChain %67 %77 
					                                 f32 %93 = OpLoad %92 
					                        Private f32* %94 = OpAccessChain %67 %77 
					                                 f32 %95 = OpLoad %94 
					                                 f32 %96 = OpFMul %93 %95 
					                        Private f32* %97 = OpAccessChain %67 %77 
					                                             OpStore %97 %96 
					                                 f32 %98 = OpLoad %86 
					                        Private f32* %99 = OpAccessChain %67 %77 
					                                f32 %100 = OpLoad %99 
					                                f32 %101 = OpFMul %98 %100 
					                       Private f32* %103 = OpAccessChain %67 %102 
					                                f32 %104 = OpLoad %103 
					                                f32 %105 = OpFAdd %101 %104 
					                       Private f32* %106 = OpAccessChain %67 %77 
					                                             OpStore %106 %105 
					                                f32 %108 = OpLoad %58 
					                                ...
					                                f32 %113 = OpFAdd %111 %112 
					                                             OpStore %107 %113 
					                                f32 %114 = OpLoad %107 
					                                f32 %115 = OpExtInst %1 43 %114 %83 %56 
					                                             OpStore %107 %115 
					                                f32 %117 = OpLoad %107 
					                                f32 %118 = OpFMul %117 %54 
					                                f32 %119 = OpFAdd %118 %90 
					                                             OpStore %116 %119 
					                                f32 %120 = OpLoad %107 
					                                f32 %121 = OpLoad %107 
					                       ...
					                       Private f32* %126 = OpAccessChain %67 %102 
					                                             OpStore %126 %125 
					                                f32 %127 = OpLoad %58 
					                                f32 %128 = OpFNegate %127 
					                                f32 %130 = OpFMul %128 %129 
					                                f32 %131 = OpFAdd %130 %56 
					                                             OpStore %107 %131 
					                                f32 %132 = OpLoad %58 
					                       ...
					                       Private f32* %153 = OpAccessChain %67 %152 
					                                             OpStore %153 %151 
					                                f32 %154 = OpLoad %58 
					                              ...
					                              f32_3 %157 = OpFMul %155 %156 
					                                             OpStore %67 %157 
					                              f32_3 %158 = OpLoad %67 
					                              f32_3 %159 = OpCompositeConstruct %83 %83 %83 
