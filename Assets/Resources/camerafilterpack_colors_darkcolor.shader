			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_6 = u_xlat10_0.z + u_xlat16_6;
					    u_xlat16_1.xyz = u_xlat10_0.xyz * vec3(u_xlat16_6) + (-u_xlat10_0.xyz);
					    SV_Target0.xyz = vec3(vec3(_Value, _Value, _Value)) * u_xlat16_1.xyz + u_xlat10_0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}
					...
					UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
					                        ...
					                        Uniform f32* %73 = OpAccessChain %16 %69 
					                                 f32 %74 = OpLoad %73 
					                        Uniform f32* %75 = OpAccessChain %16 %69 
					                                 f32 %76 = OpLoad %75 
					                               ...
					                               f32_4 %87 = OpVectorShuffle %86 %85 4 5 6 3 
					                                             OpStore %68 %87 
					                         Output f32* %91 = OpAccessChain %68 %89 
					                                             OpStore %91 %88 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
