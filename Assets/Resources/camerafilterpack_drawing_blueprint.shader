			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat16_1.xyz = u_xlat10_1.xxx * vec3(0.174999997, 0.40200001, 0.686999977) + vec3(0.100000001, 0.100000001, 0.100000001);
					    u_xlat14.x = (-_Value5) + 1.0;
					    u_xlat7.x = u_xlat14.x * (-u_xlat16_7) + u_xlat16_7;
					    u_xlat0.x = u_xlat7.x * (-u_xlat0.x) + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * _Value3;
					    u_xlat7.xyz = (-u_xlat16_1.xyz) + _PColor2.xyz;
					    u_xlat7.xyz = vec3(vec3(_Value6, _Value6, _Value6)) * u_xlat7.xyz + u_xlat16_1.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                               ...
					                                               %1 = OpExtInstImport "GLSL.std.450" 
					                                                      OpMemoryModel Logical GLSL450 
					                                                      OpEntryPoint Fragment %4 "main" %60 %468 
					        ...
					        UniformConstant read_only Texture2D* %129 = OpVariable UniformConstant 
					                    UniformConstant sampler* %131 = OpVariable UniformConstant 
					                              ...
					                              Private f32_3* %386 = OpVariable Private 
					                                       ...
					                                       f32_3 %392 = OpConstantComposite %389 %390 %391 
					                                         f32 %394 = OpConstant 3,674022E-40 
					                                       f32_3 %395 = OpConstantComposite %394 %394 %394 
					                                         i32 %397 = OpConstant 7 
					                                         i32 %429 = OpConstant 1 
					                                         i32 %434 = OpConstant 8 
					                                         i32 %452 = OpConstant 0 
					                                             %467 = OpTypePointer Output %10 
					                  ...
					                  read_only Texture2DSampled %236 = OpSampledImage %234 %235 
					                                ...
					                                Private f32* %382 = OpAccessChain %72 %45 
					                                       ...
					                                       f32_3 %396 = OpFAdd %393 %395 
					                                                      OpStore %386 %396 
					                                Uniform f32* %398 = OpAccessChain %13 %397 
					                                         f32 %399 = OpLoad %398 
					                                         f32 %400 = OpFNegate %399 
					                                         f32 %401 = OpFAdd %400 %161 
					                                Private f32* %402 = OpAccessChain %58 %24 
					                                                      OpStore %402 %401 
					                                Private f32* %403 = OpAccessChain %58 %24 
					                                         f32 %404 = OpLoad %403 
					                                         f32 %405 = OpLoad %381 
					                                ...
					                                Private f32* %410 = OpAccessChain %179 %24 
					                                                      OpStore %410 %409 
					                                Private f32* %411 = OpAccessChain %179 %24 
					                                         f32 %412 = OpLoad %411 
					                                Private f32* %413 = OpAccessChain %9 %24 
					                                         f32 %414 = OpLoad %413 
					                                         f32 %415 = OpFNegate %414 
					                                         f32 %416 = OpFMul %412 %415 
					                                ...
					                                Private f32* %421 = OpAccessChain %9 %24 
					                                         f32 %422 = OpLoad %421 
					                                Uniform f32* %423 = OpAccessChain %13 %371 
					                                         f32 %424 = OpLoad %423 
					                                         f32 %425 = OpFMul %422 %424 
					                                Private f32* %426 = OpAccessChain %9 %24 
					                                                      OpStore %426 %425 
					                                       f32_3 %427 = OpLoad %386 
					                                       f32_3 %428 = OpFNegate %427 
					                              Uniform f32_4* %430 = OpAccessChain %13 %429 
					                                       f32_4 %431 = OpLoad %430 
					                                       f32_3 %432 = OpVectorShuffle %431 %431 0 1 2 
					                                       f32_3 %433 = OpFAdd %428 %432 
					                                                      OpStore %179 %433 
					                                Uniform f32* %435 = OpAccessChain %13 %434 
					                                         f32 %436 = OpLoad %435 
					                                Uniform f32* %437 = OpAccessChain %13 %434 
					                                         f32 %438 = OpLoad %437 
					                                Uniform f32* %439 = OpAccessChain %13 %434 
					                                         f32 %440 = OpLoad %439 
					                                       f32_3 %441 = OpCompositeConstruct %436 %438 %440 
					                                         f32 %442 = OpCompositeExtract %441 0 
					                                         f32 %443 = OpCompositeExtract %441 1 
					                                         f32 %444 = OpCompositeExtract %441 2 
					                                       f32_3 %445 = OpCompositeConstruct %442 %443 %444 
					                                       f32_3 %446 = OpLoad %179 
					                                       f32_3 %447 = OpFMul %445 %446 
					                                       f32_3 %448 = OpLoad %386 
					                                       f32_3 %449 = OpFAdd %447 %448 
					                                                      OpStore %179 %449 
					                                       f32_3 %450 = OpLoad %179 
					                                       f32_3 %451 = OpFNegate %450 
					                              Uniform f32_4* %453 = OpAccessChain %13 %452 
					                                       ...
					                                       f32_3 %461 = OpLoad %179 
					                                       f32_3 %462 = OpFAdd %460 %461 
					                                                      OpStore %9 %462 
					                                       f32_3 %463 = OpLoad %146 
					                                       f32_3 %464 = OpFNegate %463 
					                                       f32_3 %465 = OpLoad %9 
					                                       f32_3 %466 = OpFAdd %464 %465 
					                                                      OpStore %9 %466 
					                                Uniform f32* %470 = OpAccessChain %13 %469 
					                                         f32 %471 = OpLoad %470 
					                                Uniform f32* %472 = OpAccessChain %13 %469 
					                                         f32 %473 = OpLoad %472 
					                                Uniform f32* %474 = OpAccessChain %13 %469 
					                                         f32 %475 = OpLoad %474 
					                                       ...
					                                       f32_3 %483 = OpLoad %146 
					                                       f32_3 %484 = OpFAdd %482 %483 
					                                       f32_4 %485 = OpLoad %468 
					                                       f32_4 %486 = OpVectorShuffle %485 %484 4 5 6 3 
					                                                      OpStore %468 %486 
					                                 Output f32* %489 = OpAccessChain %468 %487 
					                                                      OpStore %489 %161 
					                                                      OpReturn
					                                                      OpFunctionEnd"
				}
