			...
			Program "vp" {
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %234 
					     ...
					     UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					                 UniformConstant sampler* %79 = OpVariable UniformConstant 
					                         ...
					                         Private bool_3* %182 = OpVariable Private 
					                                         %189 = OpTypePointer Function %24 
					                                         %233 = OpTypePointer Output %11 
					                           Output f32_4* %234 = OpVariable Output 
					                                     i32 %235 = OpConstant 0 
					                                     u32 %253 = OpConstant 3 
					                                         %254 = OpTypePointer Output %9 
					                                      void %4 = OpFunction None %3 
					                                           %5 = OpLabel 
					                            Function f32* %51 = OpVariable Function 
					                           Function f32* %141 = OpVariable Function 
					                           Function f32* %153 = OpVariable Function 
					                           Function f32* %165 = OpVariable Function 
					                         Function f32_3* %190 = OpVariable Function 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                  ...
					                                  bool_4 %132 = OpFOrdLessThan %128 %130 
					                                  bool_3 %133 = OpVectorShuffle %132 %132 0 1 2 
					                                                  OpStore %126 %133 
					                                   f32_3 %135 = OpLoad %104 
					                                   f32_3 %136 = OpLoad %104 
					                                   f32_3 %137 = OpFAdd %135 %136 
					                                                  OpStore %134 %137 
					                           Private bool* %139 = OpAccessChain %126 %138 
					                                    bool %140 = OpLoad %139 
					                                                  OpSelectionMerge %143 None 
					                                                  OpBranchConditional %140 %142 %146 
					                                         %142 = OpLabel 
					                            Private f32* %144 = OpAccessChain %134 %138 
					                                     f32 %145 = OpLoad %144 
					                                                  OpStore %141 %145 
					                                                  OpBranch %143 
					                                         %146 = OpLabel 
					                            Private f32* %147 = OpAccessChain %97 %138 
					                                     f32 %148 = OpLoad %147 
					                                                  OpStore %141 %148 
					                                                  OpBranch %143 
					                                         %143 = OpLabel 
					                                     f32 %149 = OpLoad %141 
					                            Private f32* %150 = OpAccessChain %26 %138 
					                                                  OpStore %150 %149 
					                           Private bool* %151 = OpAccessChain %126 %18 
					                                    bool %152 = OpLoad %151 
					                                                  OpSelectionMerge %155 None 
					                                                  OpBranchConditional %152 %154 %158 
					                                         %154 = OpLabel 
					                            Private f32* %156 = OpAccessChain %134 %18 
					                                     f32 %157 = OpLoad %156 
					                                                  OpStore %153 %157 
					                                                  OpBranch %155 
					                                         %158 = OpLabel 
					                            Private f32* %159 = OpAccessChain %97 %18 
					                                     f32 %160 = OpLoad %159 
					                                                  OpStore %153 %160 
					                                                  OpBranch %155 
					                                         %155 = OpLabel 
					                                     f32 %161 = OpLoad %153 
					                            Private f32* %162 = OpAccessChain %26 %18 
					                                                  OpStore %162 %161 
					                           Private bool* %163 = OpAccessChain %126 %59 
					                                    bool %164 = OpLoad %163 
					                                                  OpSelectionMerge %167 None 
					                                                  OpBranchConditional %164 %166 %170 
					                                         %166 = OpLabel 
					                            Private f32* %168 = OpAccessChain %134 %59 
					                                     f32 %169 = OpLoad %168 
					                                                  OpStore %165 %169 
					                                                  OpBranch %167 
					                                         %170 = OpLabel 
					                            Private f32* %171 = OpAccessChain %97 %59 
					                                     f32 %172 = OpLoad %171 
					                                                  OpStore %165 %172 
					                                                  OpBranch %167 
					                                         %167 = OpLabel 
					                                     f32 %173 = OpLoad %165 
					                            Private f32* %174 = OpAccessChain %26 %59 
					                                                  OpStore %174 %173 
					                                   f32_3 %175 = OpLoad %104 
					                                   f32_3 %178 = OpFMul %175 %177 
					                                   f32_3 %181 = OpFAdd %178 %180 
					                                                  OpStore %134 %181 
					                                   f32_3 %183 = OpLoad %97 
					                                   f32_4 %184 = OpVectorShuffle %183 %183 0 1 2 0 
					                                   f32_3 %185 = OpLoad %134 
					                                   f32_4 %186 = OpVectorShuffle %185 %185 0 1 2 0 
					                                  bool_4 %187 = OpFOrdLessThan %184 %186 
					                                  bool_3 %188 = OpVectorShuffle %187 %187 0 1 2 
					                                                  OpStore %182 %188 
					                                   f32_3 %191 = OpLoad %26 
					                                                  OpStore %190 %191 
					                           Private bool* %192 = OpAccessChain %182 %138 
					                                    bool %193 = OpLoad %192 
					                                                  OpSelectionMerge %196 None 
					                                                  OpBranchConditional %193 %195 %199 
					                                         %195 = OpLabel 
					                            Private f32* %197 = OpAccessChain %134 %138 
					                                     f32 %198 = OpLoad %197 
					                                                  OpStore %194 %198 
					                                                  OpBranch %196 
					                                         %199 = OpLabel 
					                            Private f32* %200 = OpAccessChain %26 %138 
					                                     f32 %201 = OpLoad %200 
					                                                  OpStore %194 %201 
					                                                  OpBranch %196 
					                                         %196 = OpLabel 
					                                     f32 %202 = OpLoad %194 
					                           Function f32* %203 = OpAccessChain %190 %138 
					                                                  OpStore %203 %202 
					                           Private bool* %204 = OpAccessChain %182 %18 
					                                    bool %205 = OpLoad %204 
					                                                  OpSelectionMerge %208 None 
					                                                  OpBranchConditional %205 %207 %211 
					                                         %207 = OpLabel 
					                            Private f32* %209 = OpAccessChain %134 %18 
					                                     f32 %210 = OpLoad %209 
					                                                  OpStore %206 %210 
					                                                  OpBranch %208 
					                                         %211 = OpLabel 
					                            Private f32* %212 = OpAccessChain %26 %18 
					                                     f32 %213 = OpLoad %212 
					                                                  OpStore %206 %213 
					                                                  OpBranch %208 
					                                         %208 = OpLabel 
					                                     f32 %214 = OpLoad %206 
					                           Function f32* %215 = OpAccessChain %190 %18 
					                                                  OpStore %215 %214 
					                           Private bool* %216 = OpAccessChain %182 %59 
					                                    bool %217 = OpLoad %216 
					                                                  OpSelectionMerge %220 None 
					                                                  OpBranchConditional %217 %219 %223 
					                                         %219 = OpLabel 
					                            Private f32* %221 = OpAccessChain %134 %59 
					                                     f32 %222 = OpLoad %221 
					                                                  OpStore %218 %222 
					                                                  OpBranch %220 
					                                         %223 = OpLabel 
					                            Private f32* %224 = OpAccessChain %26 %59 
					                                     f32 %225 = OpLoad %224 
					                                                  OpStore %218 %225 
					                                                  OpBranch %220 
					                                         %220 = OpLabel 
					                                     f32 %226 = OpLoad %218 
					                           Function f32* %227 = OpAccessChain %190 %59 
					                                                  OpStore %227 %226 
					                                   f32_3 %228 = OpLoad %190 
					                                                  OpStore %26 %228 
					                                   f32_3 %229 = OpLoad %104 
					                                   f32_3 %230 = OpFNegate %229 
					                                   f32_3 %231 = OpLoad %26 
					                                   f32_3 %232 = OpFAdd %230 %231 
					                                                  OpStore %26 %232 
					                            Uniform f32* %236 = OpAccessChain %14 %235 
					                                     f32 %237 = OpLoad %236 
					                            Uniform f32* %238 = OpAccessChain %14 %235 
					                                     f32 %239 = OpLoad %238 
					                            Uniform f32* %240 = OpAccessChain %14 %235 
					                                     f32 %241 = OpLoad %240 
					                                   f32_3 %242 = OpCompositeConstruct %237 %239 %241 
					                                     f32 %243 = OpCompositeExtract %242 0 
					                                     f32 %244 = OpCompositeExtract %242 1 
					                                     f32 %245 = OpCompositeExtract %242 2 
					                                   f32_3 %246 = OpCompositeConstruct %243 %244 %245 
					                                   f32_3 %247 = OpLoad %26 
					                                   f32_3 %248 = OpFMul %246 %247 
					                                   f32_3 %249 = OpLoad %104 
					                                   f32_3 %250 = OpFAdd %248 %249 
					                                   f32_4 %251 = OpLoad %234 
					                                   f32_4 %252 = OpVectorShuffle %251 %250 4 5 6 3 
					                                                  OpStore %234 %252 
					                             Output f32* %255 = OpAccessChain %234 %253 
					                                                  OpStore %255 %47 
					                                                  OpReturn
					                                                  OpFunctionEnd"
				}
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlatb1.xyz = lessThan(u_xlat0.xyzx, u_xlat1.xyzx).xyz;
					    u_xlat3.xyz = u_xlat0.xyz + u_xlat0.xyz;
					    u_xlat1.x = (u_xlatb1.x) ? u_xlat3.x : u_xlat2.x;
					    u_xlat1.y = (u_xlatb1.y) ? u_xlat3.y : u_xlat2.y;
					    u_xlat1.z = (u_xlatb1.z) ? u_xlat3.z : u_xlat2.z;
					    u_xlat3.xyz = u_xlat0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
					    u_xlatb2.xyz = lessThan(u_xlat2.xyzx, u_xlat3.xyzx).xyz;
					    {
