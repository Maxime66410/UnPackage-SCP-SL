			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat2.xy = u_xlat6.xx * u_xlat10_1.xx;
					    u_xlat2.z = u_xlat6.x * u_xlat10_1.x + 0.0520000011;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                       ...
					                                       %1 = OpExtInstImport "GLSL.std.450" 
					                                              OpMemoryModel Logical GLSL450 
					                                              OpEntryPoint Fragment %4 "main" %11 %203 
					        ...
					        Uniform struct {f32; f32_4;}* %16 = OpVariable Uniform 
					                       ...
					                       Private f32_3* %52 = OpVariable Private 
					                        ...
					                        Private f32* %141 = OpVariable Private 
					                                     %142 = OpTypeImage %6 Dim2D 0 0 0 1 Unknown 
					...
					UniformConstant read_only Texture2D* %144 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %151 = OpSampledImage %145 %149 
					                               f32_2 %152 = OpLoad %9 
					                               f32_4 %153 = OpImageSampleImplicitLod %151 %152 
