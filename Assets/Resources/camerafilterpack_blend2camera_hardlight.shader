			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat10_1 = texture(_MainTex2, u_xlat5.xy);
					    u_xlat10_2 = texture(_MainTex, u_xlat5.xy);
					    u_xlat16_5.xyz = u_xlat10_1.xyz + (-u_xlat10_2.xyz);
					    u_xlat1.xyz = u_xlat0.xxx * u_xlat16_5.xyz + u_xlat10_2.xyz;
					    u_xlat0.xyz = vec3(vec3(_Value2, _Value2, _Value2)) * u_xlat16_5.xyz + u_xlat10_2.xyz;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                           ...
					                                           %1 = OpExtInstImport "GLSL.std.450" 
					                                                  OpMemoryModel Logical GLSL450 
					                                                  OpEntryPoint Fragment %4 "main" %28 %203 
					     ...
					     UniformConstant read_only Texture2D* %77 = OpVariable UniformConstant 
					                 UniformConstant sampler* %79 = OpVariable UniformConstant 
					                          ...
					                          Private f32_3* %124 = OpVariable Private 
					                                         ...
					                                         %142 = OpTypePointer Private %141 
					                         Private bool_3* %143 = OpVariable Private 
					                                     f32 %146 = OpConstant 3,674022E-40 
					                                   f32_4 %147 = OpConstantComposite %146 %146 %146 %22 
					                                         %148 = OpTypeVector %6 4 
					                          Private f32_3* %151 = OpVariable Private 
					                                     u32 %152 = OpConstant 0 
					                                         %202 = OpTypePointer Output %11 
					                           Output f32_4* %203 = OpVariable Output 
					                                     i32 %204 = OpConstant 0 
					                                     u32 %222 = OpConstant 3 
					                                         %223 = OpTypePointer Output %9 
					                                      void %4 = OpFunction None %3 
					                                           %5 = OpLabel 
					               ...
					               read_only Texture2DSampled %81 = OpSampledImage %78 %80 
					                            ...
					                            Uniform f32* %109 = OpAccessChain %14 %92 
					                                   ...
					                                   f32_3 %127 = OpFAdd %126 %122 
					                                                  OpStore %124 %127 
					                                   f32_3 %128 = OpLoad %124 
					                                   ...
					                                   f32_3 %135 = OpFAdd %134 %122 
					                                                  OpStore %26 %135 
					                                   f32_3 %136 = OpLoad %97 
					                                   f32_2 %137 = OpVectorShuffle %136 %136 0 0 
					                                   f32_3 %138 = OpLoad %104 
					                                   f32_2 %139 = OpVectorShuffle %138 %138 0 0 
					                                     f32 %140 = OpDot %137 %139 
					                                                  OpStore %91 %140 
					                                   f32_3 %144 = OpLoad %104 
					                                   f32_4 %145 = OpVectorShuffle %144 %144 0 1 2 0 
					                                  bool_4 %149 = OpFOrdLessThan %145 %147 
					                                  bool_3 %150 = OpVectorShuffle %149 %149 0 1 2 
					                                                  OpStore %143 %150 
					                           Private bool* %153 = OpAccessChain %143 %152 
					                                    bool %154 = OpLoad %153 
					                                     ...
					                                     f32 %158 = OpLoad %91 
					                                                  ...
					                                                  OpBranch %157 
					                                         %159 = OpLabel 
					                            Private f32* %160 = OpAccessChain %26 %152 
					                                     f32 %161 = OpLoad %160 
					                                                  OpStore %155 %161 
					                                                  OpBranch %157 
					                                         %157 = OpLabel 
					                                     f32 %162 = OpLoad %155 
					                            Private f32* %163 = OpAccessChain %151 %152 
					                                                  OpStore %163 %162 
					                                   f32_3 %164 = OpLoad %97 
					                                   f32_2 %165 = OpVectorShuffle %164 %164 1 1 
					                                   f32_3 %166 = OpLoad %104 
					                                   f32_2 %167 = OpVectorShuffle %166 %166 1 1 
					                                     f32 %168 = OpDot %165 %167 
					                                                  OpStore %91 %168 
					                                   f32_3 %169 = OpLoad %97 
					                                   f32_2 %170 = OpVectorShuffle %169 %169 2 2 
					                                   f32_3 %171 = OpLoad %104 
					                                   f32_2 %172 = OpVectorShuffle %171 %171 2 2 
					                                     f32 %173 = OpDot %170 %172 
					                            Private f32* %174 = OpAccessChain %26 %152 
					                                                  OpStore %174 %173 
					                           Private bool* %175 = OpAccessChain %143 %59 
					                                    bool %176 = OpLoad %175 
					                                                  OpSelectionMerge %179 None 
					                                                  OpBranchConditional %176 %178 %182 
					                                         %178 = OpLabel 
					                            Private f32* %180 = OpAccessChain %26 %152 
					                                     f32 %181 = OpLoad %180 
					                                                  OpStore %177 %181 
					                                                  OpBranch %179 
					                                         %182 = OpLabel 
					                            Private f32* %183 = OpAccessChain %26 %59 
					                                     f32 %184 = OpLoad %183 
					                                                  OpStore %177 %184 
					                                                  OpBranch %179 
					                                         %179 = OpLabel 
					                                     f32 %185 = OpLoad %177 
					                            Private f32* %186 = OpAccessChain %151 %59 
					                                                  OpStore %186 %185 
					                           Private bool* %187 = OpAccessChain %143 %18 
					                                    bool %188 = OpLoad %187 
					                                     ...
					                                     f32 %192 = OpLoad %91 
					                                                  ...
					                                                  OpBranch %191 
					                                         %193 = OpLabel 
					                            Private f32* %194 = OpAccessChain %26 %18 
					                                     f32 %195 = OpLoad %194 
					                                                  OpStore %189 %195 
					                                                  OpBranch %191 
					                                         %191 = OpLabel 
					                                     f32 %196 = OpLoad %189 
					                            Private f32* %197 = OpAccessChain %151 %18 
					                                                  OpStore %197 %196 
					                                   f32_3 %198 = OpLoad %104 
					                                   f32_3 %199 = OpFNegate %198 
					                                   f32_3 %200 = OpLoad %151 
					                                   f32_3 %201 = OpFAdd %199 %200 
					                                                  OpStore %26 %201 
					                            Uniform f32* %205 = OpAccessChain %14 %204 
					                                     f32 %206 = OpLoad %205 
					                            Uniform f32* %207 = OpAccessChain %14 %204 
					                                     f32 %208 = OpLoad %207 
					                            Uniform f32* %209 = OpAccessChain %14 %204 
					                                     f32 %210 = OpLoad %209 
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = vec3(u_xlat15) * u_xlat16_0.xyz + u_xlat10_1.xyz;
