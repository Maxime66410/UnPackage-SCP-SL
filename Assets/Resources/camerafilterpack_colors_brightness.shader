			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat10_1.xyz * vec3(_Val);
					    u_xlatb6 = _Val<1.0;
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %29 %73 
					...
					UniformConstant read_only Texture2D* %44 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %51 = OpSampledImage %45 %49 
					                               ...
					                               f32_3 %59 = OpFAdd %57 %58 
					                                             OpStore %55 %59 
					                               f32_3 %60 = OpLoad %41 
					                        Uniform f32* %61 = OpAccessChain %13 %15 
					                                 f32 %62 = OpLoad %61 
					                               f32_3 %63 = OpCompositeConstruct %62 %62 %62 
					                               f32_3 %64 = OpFMul %60 %63 
					                                             OpStore %9 %64 
					                        Uniform f32* %68 = OpAccessChain %13 %15 
					                                 f32 %69 = OpLoad %68 
					                                bool %71 = OpFOrdLessThan %69 %70 
					                                             OpStore %67 %71 
					                                bool %74 = OpLoad %67 
					                                             OpSelectionMerge %78 None 
					                                             OpBranchConditional %74 %77 %80 
					                                     %77 = OpLabel 
					                               f32_3 %79 = OpLoad %9 
					                                             OpStore %76 %79 
					                                             OpBranch %78 
					                               ...
					                               f32_4 %84 = OpVectorShuffle %83 %82 4 5 6 3 
					                                             OpStore %73 %84 
					                         Output f32* %87 = OpAccessChain %73 %85 
					                                             OpStore %87 %70 
					                                             OpReturn
					                                             OpFunctionEnd"
				}
