			...
			Program "vp" {
				...
				SubProgram "glcore " {
					...
					void main()
					{
					    ...
					    u_xlat0 = (-u_xlat10_1) + u_xlat0.xxxx;
					    SV_Target0 = vec4(vec4(_Noise, _Noise, _Noise, _Noise)) * u_xlat0 + u_xlat10_1;
					    return;
					}
				...
				SubProgram "vulkan " {
					...
					; Schema: 0
					                                      ...
					                                      %1 = OpExtInstImport "GLSL.std.450" 
					                                             OpMemoryModel Logical GLSL450 
					                                             OpEntryPoint Fragment %4 "main" %12 %72 
					...
					UniformConstant read_only Texture2D* %41 = OpVariable UniformConstant 
					          ...
					          read_only Texture2DSampled %48 = OpSampledImage %42 %46 
					                        ...
					                        Private f32* %57 = OpAccessChain %9 %55 
					                                 f32 %58 = OpLoad %57 
					                                 f32 %60 = OpFMul %58 %59 
					                        Private f32* %61 = OpAccessChain %9 %55 
					                                             OpStore %61 %60 
					                        Private f32* %62 = OpAccessChain %9 %55 
					                                 f32 %63 = OpLoad %62 
					                                 f32 %64 = OpExtInst %1 10 %63 
					                        Private f32* %65 = OpAccessChain %9 %55 
					                                             OpStore %65 %64 
					                               f32_4 %66 = OpLoad %38 
					                               f32_4 %67 = OpFNegate %66 
					                               f32_4 %68 = OpLoad %9 
					                               f32_4 %69 = OpVectorShuffle %68 %68 0 0 0 0 
					                               f32_4 %70 = OpFAdd %67 %69 
					                                             OpStore %9 %70 
					                        Uniform f32* %75 = OpAccessChain %16 %73 
					                                 f32 %76 = OpLoad %75 
					                        Uniform f32* %77 = OpAccessChain %16 %73 
					                                 f32 %78 = OpLoad %77 
					                        Uniform f32* %79 = OpAccessChain %16 %73 
					                                 f32 %80 = OpLoad %79 
					                        Uniform f32* %81 = OpAccessChain %16 %73 
					                                 f32 %82 = OpLoad %81 
					                               f32_4 %83 = OpCompositeConstruct %76 %78 %80 %82 
					                                 f32 %84 = OpCompositeExtract %83 0 
					                                 f32 %85 = OpCompositeExtract %83 1 
					                                 f32 %86 = OpCompositeExtract %83 2 
					                                 f32 %87 = OpCompositeExtract %83 3 
					                               f32_4 %88 = OpCompositeConstruct %84 %85 %86 %87 
					                               f32_4 %89 = OpLoad %9 
